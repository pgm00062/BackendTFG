...
public interface GetProjectTotalTimeUseCase {
    ...
    TimeSessionDailyOutputDto getDailyTotalTime(String userEmail, LocalDateTime startOfDay, LocalDateTime endOfDay);
    Double getTotalHoursForProject(String userEmail, Long projectId);
} 